...
function interiorpress_getting_started_menu() {	
		$interiorpress_plugin_count = null;
		if ( !is_plugin_active( 'arile-extra/arile-extra.php' ) ):	
			$interiorpress_plugin_count =	'<span class="awaiting-mod action-count">1</span>';
		endif;
	    /* translators: %1$s %2$s: about */		
		$title = sprintf(esc_html__('About %1$s %2$s', 'interiorpress'), esc_html( ARILEWP_THEME_NAME ), $interiorpress_plugin_count);
	...
	<div class="wrap getting-started">
		...
		<div class="intro-wrap">
			...
			<div class="intro right">
				<a target="_blank" href="<?php echo 'https://themearile.com/'; ?>"><img src="<?php echo esc_url ( get_stylesheet_directory_uri().'/inc/admin/images/logo.png' ); ?>"></a>
			</div>
		</div>
		<div class="panels">
...
class interiorpress_screen {
	...
	public function interiorpress_admin_notice() {
		...
		<div class="updated notice is-dismissible interiorpress-notice">
			<h1><?php
			$interiorpress_theme_info = wp_get_theme();
			printf( esc_html__('Congratulations, Welcome to %1$s Theme', 'interiorpress'), esc_html( $interiorpress_theme_info->Name ), esc_html( $interiorpress_theme_info->Version ) ); ?>
			</h1>
